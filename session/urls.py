...
urlpatterns = [
    ...
    path('<str:code>/facilitator/login/', views.facilitator_login, name='session_facilitator_login'),
    path('<str:code>/facilitator/logout/', views.facilitator_logout, name='session_facilitator_logout'),
